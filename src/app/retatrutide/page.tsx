      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "64px 48px 0" }}>
        ...
        >
          ...
          <article>
            ...
            <section id="what-is-retatrutide" style={{ marginBottom: "56px" }}>
              <h2
                style={{
                  fontFamily: "var(--serif)",
                  fontSize: "28px",
            ...
            {/* ── SECTION 2: Mechanism ── */}
            <section id="mechanism" style={{ marginBottom: "56px" }}>
              <h2
                style={{
                  fontFamily: "var(--serif)",
                  fontSize: "28px",
            ...
            <section id="triumph-trials" style={{ marginBottom: "56px" }}>
              <h2
                style={{
                  fontFamily: "var(--serif)",
                  fontSize: "28px",
            ...
            <section id="weight-loss-data" style={{ marginBottom: "56px" }}>
              <h2
                style={{
                  fontFamily: "var(--serif)",
                  fontSize: "28px",
            ...
            {/* ── SECTION 5: Liver Fat ── */}
            <section id="liver-fat" style={{ marginBottom: "56px" }}>
              <h2
                style={{
                  fontFamily: "var(--serif)",
                  fontSize: "28px",
            ...
            <section id="side-effects" style={{ marginBottom: "56px" }}>
              <h2
                style={{
                  fontFamily: "var(--serif)",
                  fontSize: "28px",
            ...
            {/* ── SECTION 8: Dosage ── */}
            <section id="dosage" style={{ marginBottom: "56px" }}>
              <h2
                style={{
                  fontFamily: "var(--serif)",
                  fontSize: "28px",
            ...
            <section id="fda-timeline" style={{ marginBottom: "56px" }}>
              <h2
                style={{
                  fontFamily: "var(--serif)",
                  fontSize: "28px",
            ...
            <section id="who-qualifies" style={{ marginBottom: "56px" }}>
              <h2
                style={{
                  fontFamily: "var(--serif)",
                  fontSize: "28px",
            ...
            {/* ── SECTION 11: Unknowns ── */}
            <section id="unknowns" style={{ marginBottom: "56px" }}>
              <h2
                style={{
                  fontFamily: "var(--serif)",
                  fontSize: "28px",
